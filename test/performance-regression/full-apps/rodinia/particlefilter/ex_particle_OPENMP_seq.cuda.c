...
*/
class pragma373_omp_parallel_hclib_async {
    private:
    ...
    public:
        pragma373_omp_parallel_hclib_async(double* set_weights,
                int set_x,
                int set_Nparticles) {
...
class pragma388_omp_parallel_hclib_async {
    private:
        void **host_allocations;
        size_t *host_allocation_sizes;
        unsigned nallocations;
...
class pragma402_omp_parallel_hclib_async {
    private:
        void **host_allocations;
        size_t *host_allocation_sizes;
        unsigned nallocations;
    ...
    public:
        pragma402_omp_parallel_hclib_async(double* set_arrayX,
                int set_x,
                int set_A,
                int set_C,
                long set_M,
...
class pragma410_omp_parallel_hclib_async {
    private:
        void **host_allocations;
        size_t *host_allocation_sizes;
        unsigned nallocations;
    ...
    public:
        pragma410_omp_parallel_hclib_async(int set_y,
                int set_countOnes,
                int set_indX,
                double* set_arrayX,
                int set_x,
...
class pragma433_omp_parallel_hclib_async {
    private:
        void **host_allocations;
        size_t *host_allocation_sizes;
        unsigned nallocations;
    ...
    public:
        pragma433_omp_parallel_hclib_async(double* set_weights,
                int set_x,
                double* set_likelihood) {
            h_weights = set_weights;
            x = set_x;
...
class pragma440_omp_parallel_hclib_async {
    private:
        void **host_allocations;
        size_t *host_allocation_sizes;
        unsigned nallocations;
    ...
    public:
        pragma440_omp_parallel_hclib_async(double set_sumWeights,
                double* set_weights,
                int set_x) {
...
class pragma446_omp_parallel_hclib_async {
    private:
        void **host_allocations;
        size_t *host_allocation_sizes;
        unsigned nallocations;
    ...
    public:
        pragma446_omp_parallel_hclib_async(double* set_weights,
                int set_x,
...
class pragma455_omp_parallel_hclib_async {
    private:
        void **host_allocations;
        size_t *host_allocation_sizes;
        unsigned nallocations;
    ...
    public:
        pragma455_omp_parallel_hclib_async(double set_xe,
                double* set_arrayX,
                int set_x,
                double* set_weights,
                double set_ye,
...
class pragma480_omp_parallel_hclib_async {
    private:
        void **host_allocations;
        size_t *host_allocation_sizes;
        unsigned nallocations;
    ...
    public:
        pragma480_omp_parallel_hclib_async(double* set_u,
                int set_x,
                double set_u1,
                int set_Nparticles) {
            h_u = set_u;
...
class pragma488_omp_parallel_hclib_async {
    private:
        void **host_allocations;
        size_t *host_allocation_sizes;
        unsigned nallocations;
    ...
    public:
        pragma488_omp_parallel_hclib_async(int set_i,
                double* set_CDF,
                int set_Nparticles,
                double* set_u,
                int set_j,
...
kernel_launcher("pragma373_omp_parallel", iters_offset, niters, pragma373_omp_parallel_hclib_async(weights, x, Nparticles));
 } 
 ...
 { const int niters = (Nparticles) - (0);
const int iters_offset = (0);
kernel_launcher("pragma388_omp_parallel", iters_offset, niters, pragma388_omp_parallel_hclib_async(arrayX, x, xe, arrayY, ye));
 } 
	int k;
 ...
 { const int niters = (Nparticles) - (0);
const int iters_offset = (0);
kernel_launcher("pragma402_omp_parallel", iters_offset, niters, pragma402_omp_parallel_hclib_async(arrayX, x, A, C, M, seed, arrayY));
 } 
 ...
 { const int niters = (Nparticles) - (0);
const int iters_offset = (0);
kernel_launcher("pragma410_omp_parallel", iters_offset, niters, pragma410_omp_parallel_hclib_async(y, countOnes, indX, arrayX, x, objxy, indY, arrayY, ind, IszY, Nfr, k, max_size, likelihood, I));
 } 
 ...
 { const int niters = (Nparticles) - (0);
const int iters_offset = (0);
kernel_launcher("pragma433_omp_parallel", iters_offset, niters, pragma433_omp_parallel_hclib_async(weights, x, likelihood));
 } 
 ...
 { const int niters = (Nparticles) - (0);
const int iters_offset = (0);
kernel_launcher("pragma440_omp_parallel", iters_offset, niters, pragma440_omp_parallel_hclib_async(sumWeights, weights, x));
 } 
		long long sum_time = get_time();
		printf("TIME TO SUM WEIGHTS TOOK: %f\n", elapsed_time(exponential, sum_time));
 { const int niters = (Nparticles) - (0);
const int iters_offset = (0);
kernel_launcher("pragma446_omp_parallel", iters_offset, niters, pragma446_omp_parallel_hclib_async(weights, x, sumWeights));
 } 
 ...
 { const int niters = (Nparticles) - (0);
const int iters_offset = (0);
kernel_launcher("pragma455_omp_parallel", iters_offset, niters, pragma455_omp_parallel_hclib_async(xe, arrayX, x, weights, ye, arrayY));
 } 
 ...
 { const int niters = (Nparticles) - (0);
const int iters_offset = (0);
kernel_launcher("pragma480_omp_parallel", iters_offset, niters, pragma480_omp_parallel_hclib_async(u, x, u1, Nparticles));
 } 
 ...
 { const int niters = (Nparticles) - (0);
const int iters_offset = (0);
kernel_launcher("pragma488_omp_parallel", iters_offset, niters, pragma488_omp_parallel_hclib_async(i, CDF, Nparticles, u, j, xj, arrayX, yj, arrayY));
 } 
