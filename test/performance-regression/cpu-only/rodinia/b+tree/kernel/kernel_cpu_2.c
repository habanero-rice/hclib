				...
				int *reclength)
{
 ...
 { 
pragma93 *new_ctx = (pragma93 *)malloc(sizeof(pragma93));
new_ctx->thid = thid;
new_ctx->bid = bid;
...
domain[0].stride = 1;
domain[0].tile = 1;
hclib_future_t *fut = hclib_forasync_future((void *)pragma93_hclib_async, new_ctx, NULL, 1, domain, FORASYNC_MODE_RECURSIVE);
