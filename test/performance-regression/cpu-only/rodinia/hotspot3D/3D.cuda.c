...
kernel_launcher("pragma157_omp_parallel", iters_offset, niters, pragma157_omp_parallel_hclib_async(ny, nx, z, nz, tOut_t, cc, tIn_t, cw, ce, cs, cn, cb, ct, dt, Cap, pIn, amb_temp));
 } 
            float *t = tIn_t;
            tIn_t = tOut_t;
            tOut_t = t; 
