...
#SBATCH --job-name=BENCHMARK-N_NODESnodes-PROC_PER_NODEpernode-SET_OMPthreads
...
HCLIB_WORKERS=SET_OMP OMP_NUM_THREADS=SET_OMP srun ./BENCHMARK_EXE BENCHMARK_ARGS
